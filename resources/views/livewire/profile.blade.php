                  ...
                  <div class="tab-pane active" id="settings">
                    <form wire:submit.prevent="UpdateProfile" class="form-horizontal">
                      ...
                      {{-- <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" wire:model="gender" class="form-control" id="inputName2" placeholder="Gender">
                        </div>
                      </div> --}}
                      <div class="form-group row">
                        <label for="inputName2" class="col-sm-2 col-form-label">Image</label>
                        <div class="col-sm-10">
                          <input type="file" wire:model="photo" class="form-control" id="inputName2" placeholder="">
                        </div>
                      </div>
                      <div class="form-group row">
