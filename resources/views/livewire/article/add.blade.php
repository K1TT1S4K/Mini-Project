                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <input type="text" id="inputName" wire:model="gender"
                                            class="form-control">
                                        @error('gender')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="inputName" wire:model="height"
                                            class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputStatus">Gender</label>
                                        <select id="inputStatus" wire:model="gender"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="inputName" wire:model="detail"
                                            class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputName">File</label>
                                        <input type="file" id="inputName" wire:model="file"
                                            class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputName">Image</label>
                                        <input type="file" id="inputName" wire:model="image"
                                            class="form-control">
                                    </div>
                                </div>
                                <!-- /.card-body -->
